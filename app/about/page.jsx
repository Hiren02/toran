    ...
    <div>
      <div className="flex justify-center">
        <div className="flex flex-col max-w-7xl justify-center items-center">
          <div className="overflow-hidden w-3/4 bg-white m-4 shadow-lg flex flex-col md:flex-row justify-center shadow-orange-600  rounded-xl">
          ...
          <div className="overflow-hidden w-3/4 bg-white m-4 shadow-lg flex flex-col md:flex-row justify-center shadow-cyan-500/50 rounded-xl">
            <div className="grid p-2">
          ...
          <div className="overflow-hidden w-3/4 bg-white m-4 shadow-lg flex flex-col md:flex-row justify-center shadow-gray-600 rounded-xl">
