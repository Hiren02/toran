...
import TimeSlotSlider from '@/components/TimeSlotSlider/page';
    ...
    <div className='pt-36 pb-36'>
      <div className="flex justify-center h-100">
        <div className="w-4/5 my-5 mx-auto flex bg-gray-100 flex-col items-center md:flex-row ">
                  ...
                  <div className='mt-5'>
                    <div className='grid-cols-1 gap-x-4 md:grid-cols-2'>
                      <div className='col-span-6'>
                        <div className='mb-4'>
                          <label className='pl-4 text-lg'>Select Sports</label>
                      ...
                      <div className='col-span-6 rounded-2xl'>
                        <div className='mb-4'>
                          <label className='pl-4 text-lg'>Select Date</label>
                          <Controller
                            control={control}
                            name='DOB'
                            render={({ field }) => (
                      ...
                      <div className='col-span-6'>
                        <div className='mb-4'>
                          ...
                          <div className='rounded-xl pt-2 border-spacing-3 px-2 py-2 w-full border-2 border-midextralightgray'>
                            {/* <select multiple> */}
                            {/* {/* <option className='bg-white rounded-xl p-2 m-1'>6-7AM</option> */}
                            <span className='bg-white rounded-xl p-2 m-1'>6-7AM</span>
                            {/* </select> */}
                          </div>
                        </div>
                      </div>
          ...
          <div className="border w-[70%] md:w-[40%] bg-gray-100 items-center flex flex-col justify-center leading-7 space-y-8 h-full">
            {/* <Image src={CartImage} alt="Cart" className="" /> */}
            {/* <h3 className="text-black">Your Cart is empty</h3> */}
            <h2 className='text-orange-400 font-extrabold text-2xl'> Your cart</h2>
            <div>
            ...
            <div>
              <button className='text-2xl font-bold text-black rounded-xl m-1 p-2 border-orange-400 bg-orange-400'>Procced to pay</button>
            </div>
          </div>
        </div>
      </div>
